...
public class SoapService implements ISoapService {
	...
	@Override
	public void getLastWatchData(Object[] property_va) {
		// TODO Auto-generated method stub
		String[] property_nm = {"areanumber","houseserial"};
//		String[] property_nm = {"username","password"};
		asynTaskBase.setMethod(SOAP_UTILS.METHOD.GETLASTWATCHDATA);
		...
		asynTaskBase.executeDo(new HttpObjectResult() {
			...
			public void soapResult(Object obj) {
				...
				try {
					...
					soapRes.setObj(user);
					soapRes.setCode(SOAP_UTILS.METHOD.GETLASTWATCHDATA);
