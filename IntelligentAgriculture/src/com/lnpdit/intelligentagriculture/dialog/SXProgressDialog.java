package com.lnpdit.intelligentagriculture.dialog;
...
public class SXProgressDialog extends Dialog {
	...
	public SXProgressDialog setCloseable(boolean b) {
		LinearLayout progress_close_layout = (LinearLayout) customProgressDialog
				.findViewById(R.id.progress_close_layout);
